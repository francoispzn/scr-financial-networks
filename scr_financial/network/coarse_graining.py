...
class SpectralCoarseGraining:
    ...
    def coarse_grain(self, k: Optional[int] = None) -> np.ndarray:
        ...
        # Extract an approximate adjacency from the reconstructed Laplacian.
        # Note: D here is not the original degree matrix but the diagonal of
        # the spectral reconstruction of L_cg, which is an approximation only.
        # The off-diagonal negatives of L_cg give the approximate edge weights.
